...
pcall(function()
    ...
    local function onClick() if Web then Web:OpenURL("https://t.me/") end end
    if Msg and Msg.Show then
        Msg.Show(4, "✦ WELCOME – ELITE ULTIMATE ✦",
...
local function ESPTick()
    ...
    if not crowded and HUD and currentPawn then
        ...
        HUD:AddDebugText("✦PLAY SAFE AVOID REPORTS✦", currentPawn, 1, {X=0,Y=0,Z=145}, {X=0,Y=0,Z=145}, {R=0,G=200,B=255,A=255}, true, false, true, nil, 1.0, true)
    end
end
...
_G.InitModMenuTab = function()
    ...
    if not SettingPageDefine.ModMenu then
        ...
        local MainStack = {
            { UI = AliasMap.Title, Text = "SETTINGS" },
